...
export const AssetPaths = {
  lanternImage: getAssetPath('texture/lantern-min.png'),
  lanternData: getAssetPath('texture/lantern-min.json'),
  plum: getAssetPath('texture/plum.png'),
  papercut1: getAssetPath('texture/papercut1-min.png'),
  papercut2: getAssetPath('texture/papercut2-min.png'),
